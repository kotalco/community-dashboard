...
function key(
  ...
  if (pageIndex === 0) return '/filecoin/nodes';
  return `/filecoin/nodes?page=${pageIndex}`;
}

export const useFilecoinNodes = (config?: SWRInfiniteConfiguration) => {
